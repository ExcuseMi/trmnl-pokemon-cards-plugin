...
var LABELS = {
        en:      { artist: 'Artist',       hp: 'HP', type: 'Type',       stage: 'Stage',      rarity: 'Rarity',      retreat: 'Retreat',  mark: 'Mark',          print: 'Print',    cards: 'Cards',  number: 'No.',   avg: 'CM Avg',    avg7: 'CM 7d',    set: 'Set',      serie: 'Series',   tcg_market: 'TCG Mkt', tcg_low: 'TCG Low', released: 'Released', evolve_from: 'Evolves from', description: 'Description' },
        fr:      { artist: 'Illustrateur', hp: 'PV', type: 'Type',       stage: 'Stade',      rarity: 'Rareté',      retreat: 'Retraite', mark: 'Marque',        print: 'Éd.',      cards: 'Cartes', number: 'No.',   avg: 'CM Moy',    avg7: 'CM 7j',    set: 'Set',      serie: 'Série',    tcg_market: 'TCG Mkt', tcg_low: 'TCG Low', released: 'Date de sortie', evolve_from: 'Évolue de', description: 'Description' },
        ...
        id:      { artist: 'Artis',        hp: 'HP', type: 'Tipe',       stage: 'Tahap',      rarity: 'Kelangkaan',  retreat: 'Mundur',   mark: 'Tanda',         print: 'Cetakan',  cards: 'Kartu',  number: 'No.',   avg: 'CM Rata',   avg7: 'CM 7h',    set: 'Set',      serie: 'Seri',     tcg_market: 'TCG Mkt', tcg_low: 'TCG Low', released: 'Rilis', evolve_from: 'Berevolusi dari', description: 'Deskripsi' },
